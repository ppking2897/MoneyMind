...
│   ├── analysis/          # 分析頁面
│   │   └── components/    # 圖表元件 (PieChart, DailyExpenseChart, MonthlyTrendChart)
│   ├── camera/            # 相機拍照 + OCR
│   ├── categorytransactions/ # 類別交易列表
│   ├── chat/              # 自然語言輸入 + 語音
│   ├── components/        # 共用元件 (CategoryIcon, EmptyStateView)
│   ├── edit/              # 編輯交易
│   ├── history/           # 歷史記錄
│   ├── home/              # 首頁
│   ├── main/              # 主畫面框架
...
│   │   ├── rules/         # 學習規則
│   │   └── theme/         # 主題設定
│   └── util/              # 工具類 (AmountFormatter, CategoryColorMapper)
